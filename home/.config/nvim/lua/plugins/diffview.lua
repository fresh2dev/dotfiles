    ...
    require('diffview').setup {
      ...
      keymaps = {
        ...
        view = {
          ...
          -- { 'n', '<C-\\>', actions.focus_files, { desc = 'Bring focus to the file panel' } },
          { 'n', '<C-\\>', actions.toggle_files, { desc = 'Toggle the file panel.' } },
        ...
        file_panel = {
          ...
          { 'n', ']a', actions.select_next_entry, { desc = 'Open the diff for the next file' } },
          { 'n', '[a', actions.select_prev_entry, { desc = 'Open the diff for the previous file' } },
          ...
          { 'n', '<F5>', actions.refresh_files, { desc = 'Update stats and entries in the file list' } },
        ...
        file_history_panel = {
          ...
          { 'n', 'dt', actions.open_in_diffview, { desc = 'Open the entry under the cursor in a diffview' } },
